...
public class RomiDrivetrain {
  ...
  public RomiDrivetrain() {
    ...
    // outputting meters / pulse
    // m_leftEncoder.setDistancePerPulse(0.07*Math.PI / kCountsPerRevolution);
    // m_rightEncoder.setDistancePerPulse(0.07*Math.PI / kCountsPerRevolution);
